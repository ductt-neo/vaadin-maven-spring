...
public class UserTableExample extends VerticalLayout implements Button.ClickListener {
    ...
    public UserTableExample() {
        ...
        table.setContainerDataSource(new BeanItemContainer<User>(User.class, new ArrayList<User>()));
        ...
        table.setCellStyleGenerator(new CellStyleGenerator() {
            public String getStyle(Object itemId, Object propertyId) {
                ...
                } else if (UserController.USER_PROPERTIES_PERSONID.equals(propertyId)) {
                    return "bold";
                } else {
                    // no style
                    return null;
