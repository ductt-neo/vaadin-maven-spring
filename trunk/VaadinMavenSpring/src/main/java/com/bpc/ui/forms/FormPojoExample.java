...
//            Collection<?> itemIds = countries.getItemIds();
//            countries.select(itemIds.iterator().next());
        	...
        	BeanItemContainer<KeyValuePojo> beanItemContainer =
                new BeanItemContainer<KeyValuePojo>(KeyValuePojo.class, pojos);
        	countries.setContainerDataSource(beanItemContainer);
        	//countries.setNullSelectionAllowed(false);
        	//countries.setItemCaptionPropertyId("value");
        	countries.setItemCaptionPropertyId("key");
      

            Collection<?> itemIds = countries.getItemIds();
            Iterator<?> it = itemIds.iterator();
            KeyValuePojo itemId = null;
            for(;it.hasNext();){
            	System.out.println("---------"+it.next());
            	//it = it.next();
            	itemId = (KeyValuePojo)it.next(); 
            	
            }
          
            countries.select(itemId);
        }
    ...
    public class KeyValuePojo {
        ...
        public boolean equals(KeyValuePojo valuePojo){
        	return this.key.equals(valuePojo.key);
        }
        public int hashCode(){
